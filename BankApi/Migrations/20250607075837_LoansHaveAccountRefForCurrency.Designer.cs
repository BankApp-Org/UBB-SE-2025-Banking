...
namespace BankApi.Migrations
{
    ...
    [Migration("20250607075837_LoansHaveAccountRefForCurrency")]
    partial class LoansHaveAccountRefForCurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Models.Bank.Loan", b =>
                {
                    ...
                    b.Property<string>("DisbursementAccountIban")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Common.Models.User", b =>
                {
                    ...
                    b.Property<int?>("BillSplitMessageId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TransferMessageId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BillSplitMessageId");

                    b.HasIndex("CNP")
                        .IsUnique();

                    b.HasIndex("ImageMessageId");
                    ...
                    b.HasIndex("TextMessageId");

                    b.HasIndex("TransferMessageId");
            ...
            modelBuilder.Entity("Common.Models.Social.BillSplitMessage", b =>
                {
                    b.HasBaseType("Common.Models.Social.Message");
                    ...
                    b.HasDiscriminator().HasValue("BillSplit");
                });

            modelBuilder.Entity("Common.Models.Social.ImageMessage", b =>
                {
                    b.HasBaseType("Common.Models.Social.Message");
            ...
            modelBuilder.Entity("Common.Models.Social.RequestMessage", b =>
                {
                    b.HasBaseType("Common.Models.Social.Message");
                    ...
                    b.ToTable("Messages", t =>
                        {
                            t.Property("Currency")
                                .HasColumnName("RequestMessage_Currency");

                            t.Property("Description")
                                .HasColumnName("RequestMessage_Description");

                            t.Property("Status")
                                .HasColumnName("RequestMessage_Status");
                        });

                    b.HasDiscriminator().HasValue("Request");
                });

            modelBuilder.Entity("Common.Models.Social.TextMessage", b =>
                {
                    b.HasBaseType("Common.Models.Social.Message");
            ...
            modelBuilder.Entity("Common.Models.Social.TransferMessage", b =>
                {
                    b.HasBaseType("Common.Models.Social.Message");
                    ...
                    b.ToTable("Messages", t =>
                        {
                            t.Property("Amount")
                                .HasColumnName("TransferMessage_Amount");

                            t.Property("Currency")
                                .HasColumnName("TransferMessage_Currency");

                            t.Property("Description")
                                .HasColumnName("TransferMessage_Description");

                            t.Property("Status")
                                .HasColumnName("TransferMessage_Status");
                        });
            ...
            modelBuilder.Entity("Common.Models.User", b =>
                {
                    b.HasOne("Common.Models.Social.BillSplitMessage", null)
                        .WithMany("Participants")
                        .HasForeignKey("BillSplitMessageId");

                    b.HasOne("Common.Models.Social.ImageMessage", null)
                        .WithMany("UsersReport")
                        .HasForeignKey("ImageMessageId");

                    b.HasOne("Common.Models.Social.TextMessage", null)
                        .WithMany("UsersReport")
                        .HasForeignKey("TextMessageId");

                    b.HasOne("Common.Models.Social.TransferMessage", null)
                        .WithMany("ListOfReceivers")
                        .HasForeignKey("TransferMessageId");
