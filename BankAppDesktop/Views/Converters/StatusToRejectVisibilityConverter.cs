namespace StockApp.Views.Converters
{
    ...
    /// <summary>
    /// Converter that returns Visible for articles that can be rejected (Pending status), otherwise Collapsed.
    /// </summary>
    public partial class StatusToRejectVisibilityConverter : BaseConverter
    {
